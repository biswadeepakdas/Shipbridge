"""Context assembly routes — query context retrieval for agents."""

from fastapi import APIRouter, Depends
from pydantic import BaseModel

from app.middleware.auth import AuthContext, get_auth_context
from app.os_layer.context import AssembledContext, assemble_context, context_cache
...
async def assemble(
    ...
    """Assemble relevant context for an agent query using hybrid retrieval."""
